...
<div class = "maincontainer">
    <div id="navbar" class="navbartest">
        ...
        <section class="navbartest_division right">
            <router-link to="/customerprofile" class="navbartest_route" tag="button"> My Profile <img src="@/assets/login.png" height="16px" width="16px"></router-link>
            <router-link to="/signout" class="navbartest_newuser" tag="button">Sign Out<img src="@/assets/new.png" height="16px" width="16px"></router-link>
